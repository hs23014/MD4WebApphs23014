...
namespace MD4WebApphs23014.Controllers
{
    public class SubmissionsController : Controller
    {
        ...
        public SubmissionsController(SchoolDbContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolDbContext = _context.Submissions.Include(s => s.Assignment).Include(s => s.Student);
        ...
        public async Task<IActionResult> Create([Bind("SubmissionId,AssignmentId,StudentId,SubmissionTime,Score")] Submission submission)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Students, "StudentId", "Surname", submission.StudentId);
            return View(submission);
        }
